...
Nonetheless, such complex stucture with combination of steady ant multiplication indeed allows to get rid of one $v$ when computing \emph{semi-local sa} (see \todo{fix~\ref{•}}).
