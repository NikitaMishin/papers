...
\todo{In general, ... For the generic case of Matrix $M$ it is not possible to
...
\todo{The above results apply both to range minimum queries and to Monge matrices with non-constant access $O(\beta)$ to queries.}
...
\end{theorem}
\todo{In other words, the theorem states that if the pattern is presented in the text then all duplicates of it would be found in the text.}
