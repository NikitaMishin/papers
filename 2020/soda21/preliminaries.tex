...
$H^{\nearrow}[0:m-1,0:n-1]$ constructed as dominance sum matrix difference between secondary and first diagonal for all adjacent 2 by 2 squares called \emph{cross-difference} matrix of  $H$
\end{definition}
